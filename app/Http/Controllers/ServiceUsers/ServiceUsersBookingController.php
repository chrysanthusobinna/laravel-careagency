...
class ServiceUsersBookingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('serviceusers.pages.bookings', compact('bookings'));
    }
    ...
    public function show($bookingId)
    {
        ...
        return view('serviceusers.pages.bookings-show', compact('booking', 'assignedCarers', 'approvedCarers'));
    }
    ...
    public function showCareGiver(Request $request, $id)
    {
        ...
        return view('serviceusers.pages.view-caregiver', compact('user'));
    }
    ...
    public function selectCarers(Request $request, $bookingId)
    {
        ...
        return redirect()->route('serviceusers.bookings.show', $booking->id)
    ...
    public function create()
    {
        ...
        return view('serviceusers.pages.bookings-create', compact('careBeneficiary'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('serviceusers.bookings.index')->with('success', 'Booking submitted successfully.');
    }
