...
@section('title', 'Carer Terms and Conditions')
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p>Welcome to Carepass. These Terms and Conditions outline the rules and regulations governing your engagement as a self-employed carer providing services through our platform. By registering and offering your services via Carepass, you agree to comply fully with these terms. Please read them carefully.</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p>To join Carepass as a carer, you must meet the following requirements:</p>
                    <ul>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <ul>
                        <li>You operate as an independent contractor and are not an employee, agent, or partner of Carepass.</li>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p>When providing services through Carepass, you agree to uphold the highest standards of professionalism and care, including:</p>
                    <ul>
                        <li>Delivering care services with compassion, respect, and consideration for the dignity and autonomy of clients.</li>
                        <li>Adhering to agreed-upon schedules and promptly communicating any changes or cancellations to clients and Carepass.</li>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p>Carepass will facilitate payments for services rendered as follows:</p>
                    <ul>
                        <li>Payments are processed weekly in arrears via bank transfer to your designated account.</li>
                        <li>You are responsible for submitting accurate invoices to Carepass for the services provided.</li>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p>Carepass is not liable for any claims, damages, or losses arising from your provision of services.</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p>Carepass reserves the right to amend these Terms and Conditions at any time. You will be notified of any changes, and continued use of the platform constitutes acceptance of the revised terms.</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p>In the event of any disputes arising between you and Carepass or clients, efforts should be made to resolve the matter amicably through negotiation and communication. If a resolution cannot be reached, the dispute may be referred to mediation or arbitration as appropriate.</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p>By registering as a carer on the Carepass platform, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.</p>
                </div>
            </div>
