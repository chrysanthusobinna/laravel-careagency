...
<section class="page-title" style="background-image: url(/mainsite-assets/images/background/page-title.jpg);">
    <div class="auto-container">
        <div class="title-outer text-center">
            <h1 class="title">Join CarePass as a Carer</h1>
...
<section class="container my-5">
    ...
    <p class="text-center">At CarePass, we connect dedicated, self-employed carers with families across the UK. If you’re passionate about making a difference, CarePass is here to support you.</p>
    ...
    <div class="row d-flex align-items-stretch mt-4">
        ...
        <div class="col-md-6 d-flex">
            <div class="p-4 border rounded shadow-lg bg-white w-100 d-flex flex-column">
                <h3 class="text-danger">Why Choose CarePass?</h3>
        ...
        <div class="col-md-6 d-flex">
            <div class="img-wrapper w-100 d-flex align-items-center justify-content-center border rounded shadow-lg bg-white p-3">
                <img src="/mainsite-assets/images/resource/news-details.jpg" alt="Join CarePass" class="img-fluid rounded">
            </div>
        </div>
    </div>
...
<!-- How CarePass Works -->
<section class="container my-5">
    <h2 class="section-title">How CarePass Works</h2>
    <div class="row">
        <div class="col-md-6">
            <div class="carepass-card">
                <h4>1. Sign Up</h4>
        ...
        <div class="col-md-6 mt-3">
            <div class="carepass-card">
                ...
                <p>Begin providing care with CarePass support.</p>
            </div>
        </div>
    </div>
</section>

<!-- The CarePass App: Your Care Companion (Now a Block of Text) -->
<section class="container my-5">
    <h2 class="section-title">The CarePass App: Your Care Companion</h2>
...
<section class="container my-5">
    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="carepass-card p-4 shadow rounded text-center w-100">
...
<!-- About CarePass (Now a Block of Text) -->
<section class="container my-5">
    <h2 class="text-danger">About CarePass</h2>
    <p>CarePass is a trusted platform that connects self-employed carers with families across the UK. We believe in empowering carers to deliver high-quality, person-centered care while providing the tools and support they need to succeed. Unlike traditional agencies, CarePass offers complete freedom and transparency. You work directly with families, choose your own hours, and get paid without any hidden fees. Our commitment is to make caregiving easier, more accessible, and rewarding for both carers and families alike.</p>
</section>
