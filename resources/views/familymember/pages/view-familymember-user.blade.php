...
@section('title', 'Family Member -Family Members')
                                ...
                                <div class="card-footer">
                                         <div class="row">
                                            <div class="col-6 mb-2">
                                                <button type="button" class="btn btn-outline-secondary w-100" onclick="window.location='{{ route('familymember.care-beneficiary.edit', $member->id) }}'">Edit Profile</button>
                                            </div>
                                            <div class="col-6 mb-2">
