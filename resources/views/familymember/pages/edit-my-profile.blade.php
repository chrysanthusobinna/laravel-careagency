        ...
        <div class="edit-profile">
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <form class="card" method="POST" action="{{ route('familymember.auth-profile.update') }}">
                        @csrf
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <button class="btn btn-outline-secondary" type="button" onclick="window.location='{{ route('familymember.auth-profile.show') }}'">Back to Profile</button>
