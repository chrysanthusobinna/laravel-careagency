            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list">
                        <a class="{{ request()->routeIs('familymember.dashboard') ? 'active' : '' }} sidebar-link sidebar-title link-nav" href="{{ route('familymember.dashboard') }}">
                    ...
                    <li class="sidebar-list">
                        <a class="{{ request()->is('familymember/eligibility*') ? 'active' : '' }} sidebar-link sidebar-title link-nav" 
                            href="{{ route('familymember.eligibility.care-beneficiary')  }}">
                            <svg class="stroke-icon">
                    ...
                    <li class="sidebar-list">
                        <a class="{{ request()->is('familymember/care-beneficiary*') ? 'active' : '' }}  sidebar-link sidebar-title link-nav" href="{{ route('familymember.care-beneficiary') }}">
                    ...
                    <li class="sidebar-list">
                        <a class="{{ request()->routeIs('familymember.knowledge-base') ? 'active' : '' }} sidebar-link sidebar-title link-nav" href="{{ route('familymember.knowledge-base') }}">
                            <svg class="stroke-icon">
                    ...
                    <li class="sidebar-list">
                        <a class="{{ request()->is('familymember/auth-profile*') ? 'active' : '' }}  sidebar-link sidebar-title link-nav" href="{{ route('familymember.auth-profile.show') }}">
                            <svg class="stroke-icon">
                    ...
                    <li class="sidebar-list">
                        <a class="{{ request()->routeIs('familymember.change-password') ? 'active' : '' }} sidebar-link sidebar-title link-nav" href="{{ route('familymember.change-password') }}">
                            <svg class="stroke-icon">
