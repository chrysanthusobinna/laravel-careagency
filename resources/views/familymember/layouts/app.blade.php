    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      <div class="page-header row">
        <div class="header-logo-wrapper col-auto">
          <div class="logo-wrapper"><a href="{{ route('familymember.dashboard') }}"><img class="img-fluid for-light" src="/dashboard-assets/images/logo/logo.png" alt=""/><img class="img-fluid for-dark" src="/dashboard-assets/images/logo/logo_light.png" alt=""/></a></div>
        </div>
            ...
            <div class="nav-right col-xxl-8 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
              <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    ...
                    @include('familymember.layouts.notification')
                  </li>
                ...
                <li class="profile-nav onhover-dropdown px-0 py-0" onclick="window.location.href='{{ route('familymember.auth-profile.show') }}'">
      ...
      <div class="page-body-wrapper horizontal-menu">
        ...
        @include('familymember.layouts.sidebar')
