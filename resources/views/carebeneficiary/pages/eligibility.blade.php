                            ...
                            <div class="card shadow-lg mb-4 border-0 mt-5" style="box-shadow: 0 4px 10px rgba(0, 0, 0, 0.8); border-radius: 0;">
                                <div class="card-body">
                                    ...
                                    <div class="text-center mb-3 mt-3">
                                        ...
                                        <a href="{{ route('carebeneficiary.eligibility.care-beneficiary.show') }}" class="btn btn-outline-primary btn-lg me-3 mb-3">
                                            <i class="fa fa-user"></i> Eligibility Request for Myself
                                        </a>
                                        <br/>
                                        <!-- Button for Family Member Request -->
                                        <a href="{{ route('carebeneficiary.eligibility.family') }}" class="btn btn-outline-secondary btn-lg">
