    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      <div class="page-header row">
        <div class="header-logo-wrapper col-auto">
          <div class="logo-wrapper"><a href="{{ route('caregiver.dashboard') }}"><img class="img-fluid for-light" src="/dashboard-assets/images/logo/logo.png" alt=""/><img class="img-fluid for-dark" src="/dashboard-assets/images/logo/logo_light.png" alt=""/></a></div>
        </div>
        ...
        <div class="header-wrapper col m-0">
          <div class="row">
            ...
            <div class="header-logo-wrapper col-auto p-0">
              <div class="logo-wrapper"><a href="{{ route('caregiver.dashboard') }}"><img class="img-fluid" src="/dashboard-assets/images/logo/logo.png" alt=""></a></div>
            ...
            <div class="nav-right col-xxl-8 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
              <ul class="nav-menus">
                ...
                <li class="profile-nav onhover-dropdown px-0 py-0" onclick="window.location.href='{{ route('caregiver.auth-profile.show') }}'">
