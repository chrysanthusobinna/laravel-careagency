...
@section('title', 'Care Giver - Dashboard')
                ...
                <div class="col-xl-8 mx-auto">
                    ...
                    <div class="card w-100 border-top border-primary border-3">
                                ...
                                <div class="profile-title">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <span class="badge bg-primary">{{ $loggedInUser->formatted_role }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <a href="{{ route('caregiver.dashboard') }}" class="btn btn-outline-secondary">Dashboard</a>
                            <a href="{{ route('caregiver.auth-profile.edit') }}" class="btn btn-secondary">Edit My Profile</a>
                        </div>
                    </div>
                </div>
            </div>
