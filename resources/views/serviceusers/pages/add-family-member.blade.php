...
@section('title', 'Serviceuser - Add Family Member')
...
<nav>
    <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-400 active">Add Family Member</li>
    </ol>
</nav>
@endsection
            ...
            <div class="edit-profile">
                <div class="row">
                    <div class="col-xl-8 mx-auto">
                        <form class="card" method="POST" action="{{ route('serviceuser.family-members.store') }}">
                            @csrf
                            <div class="card-header">
                                <h4 class="card-title mb-0">Add Family Member</h4>
                            </div>
                            <div class="card-body">
                                @include('partials._dashboard_message')

                                <div class="border shadow-sm p-3 rounded bg-white mb-4 mt-2" style="box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.1);">
                                    <p class="text-muted">
                                        You need to provide information about the family member you want to manage care for, as well as your relationship to them.
                                    </p>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Who are you to them ?</label>
                            ...
                            <div class="card-footer">
                                <p class="text-muted mb-3">
                                    By clicking "Submit", you confirm that you agree to our 
                                    <a href="{{ route('mainsite.terms.serviceuser') }}" target="_blank" class="text-primary">Terms and Conditions</a> 
                                    and that you have the consent of the person to manage their care.
                                </p>
                                <div class="d-flex justify-content-between">
                                    <button class="btn btn-outline-secondary" type="button" onclick="window.location='{{ route('serviceuser.family-members') }}'">Back to List</button>
