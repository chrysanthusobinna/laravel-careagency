                        ...
                        <div class="row">
                            <div class="card w-100 border-top border-primary border-3">
                                ...
                                <div class="card-footer">
                                    @if(Auth::user()->role === 'family_member')
                                        <div class="row">
                                            <div class="col-6 mb-2">
                                                <button type="button" class="btn btn-outline-secondary w-100" onclick="window.location='{{ route('serviceuser.family-member.edit', $member->id) }}'">Edit Profile</button>
                                            </div>
                                            <div class="col-6 mb-2">
                                                <button type="button" class="btn btn-outline-secondary w-100" onclick="window.location='{{ route('serviceuser.family-member.unlink', $member->id) }}'">Unlink Family Member</button>
                                            </div>
                                            <div class="col-6 mb-2">
                                                <button type="button" class="btn btn-outline-secondary w-100">Check Eligibility</button>
                                            </div>
                                            <div class="col-6 mb-2">
