...
<nav>
    <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-400 active">Family</li>
    </ol>
</nav>
@endsection
                            ...
                            @else 
                                ...
                                @elseif($user_eligibility_status == 'pending')
                                    <p class="lead fs-4">
                                        ...
                                        Please wait while we review your responses and provide feedback.
                                        <br/>
                                        <hr/>
                                        ...
                                        <div class="d-flex flex-column align-items-start"> <!-- Align items to the left -->
                                            @foreach(json_decode($question->options) as $index => $option)
                                                ...
                                                <div class="form-check checkbox checkbox-{{ $randomColor }} mb-2">
                                                    <input class="form-check-input" id="{{ $uniqueIdx }}" type="checkbox" name="answer[]" value="{{ $option }}"
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".next").click(function () {
            ...
            $.post("{{ route('serviceuser.eligibility.family.save',$care_beneficiary_user->id) }}", formData, function (response) {
