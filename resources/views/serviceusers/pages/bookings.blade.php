    ...
    <div class="container-fluid dashboard-3">
        ...
        <div class="container my-4">
            <div class="p-4 text-center bg-white border rounded shadow-sm" style="border-color: rgba(0, 0, 0, 0.1);">
                ...
                <a href="{{ route('serviceusers.bookings.create') }}" class="btn btn-primary btn-sm">Click here to create a new booking</a>
            </div>
        </div>
        @else
            <div class="row">
                            ...
                            <div class="table-responsive theme-scrollbar">
                                <table class="table display" id="recent-orders" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{ route('serviceusers.bookings.show', $booking->id) }}" class=" ">
