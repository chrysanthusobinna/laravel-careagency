                        ...
                        <div class="table-responsive theme-scrollbar">
                            ...
                            <div class="table-responsive theme-scrollbar p-3">
                                ...
                                <div class="border shadow-sm p-3 rounded bg-white mb-4" style="box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.1);">
                                    ...
                                    @else
                                        <p class="text-muted">
                                            You can manage your family members' profiles. You can book care for them, complete eligibility request forms, and more. 
                                            If you want to unlink a family member, kindly contact us.
                                        </p>
                                    @endif
                                </div>
