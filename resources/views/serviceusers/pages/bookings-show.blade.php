            ...
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    ...
                    <div class="card shadow-lg my-4">
                        ...
                        <div class="card-body">
                            <form id="caregiverSelectionForm" action="{{ route('serviceusers.bookings.selectCarers', $booking->id) }}" method="POST">
                                @csrf
                                <div class="table-responsive">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <a href="{{ route('serviceusers.caregivers.show', $assignment->carer->id) }}">
                    ...
                    <div class="card shadow-lg my-4">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <a href="{{ route('serviceusers.bookings.index') }}" class="btn btn-outline-secondary">Back</a>
