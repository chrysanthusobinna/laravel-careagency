$(document).ready(function () {
    ...
    let searchServiceUserRoute = "";  
                            ...
                            $.each(data, function (index, member) {
                                let row = `
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="selected_family_member" value="${member.id}">
            ...
            $(document).on("change", "input[name='selected_family_member']", function () {
                $("#selected_family_member_id").val($(this).val());
            });
        });
